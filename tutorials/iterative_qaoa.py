...
def _print_iterative_history(iterative):
    console = Console()
...
def _print_depth_comparison(
    standard_results, iterative_results, max_depth, graph, iters_per_depth
):
    console = Console()
    console.print()
    console.rule(
...
def _print_overall_best(standard_results, iterative_results):
    console = Console()
    console.print()
...
if __name__ == "__main__":
    ...
    for strategy in strategies:
        ...
        _print_iterative_history(iterative)

    # ── 3) Head-to-head: loss at each depth ───────────────────────────
    _print_depth_comparison(
        standard_results, iterative_results, MAX_DEPTH, graph, ITERS_PER_DEPTH
    )

    # ── 4) Overall best ───────────────────────────────────────────────
    _print_overall_best(standard_results, iterative_results)
