...
class TestCleanHamiltonian:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (qp.prod(qp.Identity(0), qp.Identity(1)), qp.Hamiltonian([], []), 1.0),
    ...
    def test_clean_hamiltonian_various_cases(
        ...
        try:
            # qp.equal can be sensitive, so we compare terms for robustness
            ...
            assert qp.equal(new_hamiltonian, expected_op)
...
class TestSortHamiltonianTerms:
    ...
    def test_absolute_order_sorts_by_literal_coefficient(self):
        ...
        ham = qp.Hamiltonian([0.5, -0.3, 0.1], [qp.Z(0), qp.Z(1), qp.Z(2)])
