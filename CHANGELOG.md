...
* **backends:** make polling cap unlimited by default ([f042368](https://github.com/QoroQuantum/divi/commit/f0423684b66db65e1e3160838855ee84e671f120))
* **backends:** QUBO characterization result API + warm-start helper ([59d40e8](https://github.com/QoroQuantum/divi/commit/59d40e8d9d0e3794e90ea34fd35b09909d03ffea))
* **characterization:** add presets and harden job recovery ([b4dfdad](https://github.com/QoroQuantum/divi/commit/b4dfdad389d0e9f0bae586dda7e80162d66781a7))
* **characterization:** surface verdict, classical baseline, and constraint diagnostics ([ae4c225](https://github.com/QoroQuantum/divi/commit/ae4c22554e75bfabbe23f9a6672ef694faf8a87b))
* **pipeline:** let a routine declare how often it runs ([cb6dd6f](https://github.com/QoroQuantum/divi/commit/cb6dd6fc6160b60676f27dae21368d173a087afb))
* **pipeline:** report shots and cadence alongside circuit counts ([d3dbd66](https://github.com/QoroQuantum/divi/commit/d3dbd665a6d1e2dfc9e8659cf6a9db4858493372))
* **qprog:** accept PySCF and OpenFermion chemistry inputs ([6868ea9](https://github.com/QoroQuantum/divi/commit/6868ea96cbaecde930a49daf26a6f3a8a0272dbe))
...
* **qprog:** community-based QUBO decomposition via CommunityDecomposer ([b8d74a5](https://github.com/QoroQuantum/divi/commit/b8d74a50dc7acf0e1449543eed419f23ed36f87a))
* **qprog:** community-based QUBO decomposition via CommunityDecomposer ([6286455](https://github.com/QoroQuantum/divi/commit/628645531f492f2505a38a278586fa4ac0a8d7ee))
* **qprog:** measure only observable-relevant qubits by default ([106f218](https://github.com/QoroQuantum/divi/commit/106f218bf9679d7de79a55eb3ada9fb246efb6a0))
* **qprog:** preview a whole ensemble at once ([165693f](https://github.com/QoroQuantum/divi/commit/165693fc9b4fd979fd6a5cd75d5230db79bb2852))
...
* **qprog:** require BinaryOptimizationProblem for PCE ([cdb0bed](https://github.com/QoroQuantum/divi/commit/cdb0bed5b112c8c70c801068179a3d36beb7fbe6))
...
* **qprog:** consolidate the metric-estimator contract ([7e64879](https://github.com/QoroQuantum/divi/commit/7e64879d4c17fd37d3aa03071644f38ec468c089))
* **qprog:** give a program a single n_params ([742fc58](https://github.com/QoroQuantum/divi/commit/742fc585e942b65dbdbd81d67e35c03e1c6a889e))
...
* refresh references to renamed ensemble classes ([654c4b5](https://github.com/QoroQuantum/divi/commit/654c4b56ebd19e6fca28da0b7e32c165ffaceaf1))
