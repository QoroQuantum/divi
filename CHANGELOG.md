...
## [0.5.0](https://github.com/QoroQuantum/divi/compare/v0.12.0...v0.5.0) (2026-06-05)
...
* add MaxWeightMatchingProblem with edge-based partitioning ([caf5751](https://github.com/QoroQuantum/divi/commit/caf5751d152b0451a96530eeb1251115e2b2603d))
* add PHQC docs and wire feasibility modes for routing ([a8ef52b](https://github.com/QoroQuantum/divi/commit/a8ef52bc1aa2486c21b784da2cc335bf9d9078a6))
...
* added circuit depth tracker for ParallelSimulator ([2c57445](https://github.com/QoroQuantum/divi/commit/2c57445a293a9d1b8f07d4a9dc7ce28816d51280))
* added early stopping to variational algorithms ([aaf70f0](https://github.com/QoroQuantum/divi/commit/aaf70f05ed39e0874211ad1e23d1d51e1f90b336))
* added pipeline execution model ([#59](https://github.com/QoroQuantum/divi/issues/59)) ([b945836](https://github.com/QoroQuantum/divi/commit/b945836924347271d06470293bb2759fa9526715))
* Adding polynomial encoding for PCE and tests for it ([8537c5c](https://github.com/QoroQuantum/divi/commit/8537c5ca9318d11a86153aed2db7981ae3745cb5))
* beam search for partitioning program batches ([301ffc9](https://github.com/QoroQuantum/divi/commit/301ffc9841acd44ef8d7ea2f4773ca43a1dbd3a6))
...
* **dry-run:** connect circuit count to cost/depth users plan against ([2724cd6](https://github.com/QoroQuantum/divi/commit/2724cd6073fd986e017924bcc22c8b7d87ee1a45))
* enable passing maestro noise models in divi ([0caeaf6](https://github.com/QoroQuantum/divi/commit/0caeaf6342a55aa684e9d03b6cb1fa769a77c4a9))
* expose maestro noise models + multi-observable QEM ([42775ab](https://github.com/QoroQuantum/divi/commit/42775abb2ecfa1069f314138b8cac39d04d84172))
...
* **hamiltonians:** widen to_spo, add qubo_to_spo ([d2c5858](https://github.com/QoroQuantum/divi/commit/d2c5858b3c355cf6b86f4a32357b898bae46f9d1))
* implement Hamiltonian observable compression ([178fdb9](https://github.com/QoroQuantum/divi/commit/178fdb990dac13cb49f28f266e8d0e5128a0d021))
* implement Hamiltonian observable compression ([982c0ce](https://github.com/QoroQuantum/divi/commit/982c0ce1963d9a793953b9c052ce4d0efe635f9c))
* integrate QCC ansatz into divi's Ansatz framework ([2f473e7](https://github.com/QoroQuantum/divi/commit/2f473e78a251d912b512d8799c2c1c97b6a075e6))
* integrate QDrift with QAOA and add tests ([666a9bd](https://github.com/QoroQuantum/divi/commit/666a9bd45ac38f575e88ae327395834a9fe81084))
* introduce ExecutionConfig for QoroService ([107b6e4](https://github.com/QoroQuantum/divi/commit/107b6e4927128ab683f35b3c6c7d514ef522150f))
* introduced TrotterizationStrategy object and adding QDrift as a strategy ([4293a28](https://github.com/QoroQuantum/divi/commit/4293a28e0c442bd555d07137d170fa3f30dfb781))
...
* parallel observable grouping in QEM ([d70c44d](https://github.com/QoroQuantum/divi/commit/d70c44d54721969d2d95d24ab0a30e137d54e8dd))
...
* **PCE:** added new decode_parities_fn attribute for custom bitstring decoding ([3c91b92](https://github.com/QoroQuantum/divi/commit/3c91b92197e27f9f4d1353148b4610c992882a23))
...
* **qprog:** add compute_solution() to sample without retraining ([c33468a](https://github.com/QoroQuantum/divi/commit/c33468a18e9e48506e4bb0e04be3f8772a96a4ae))
* **qprog:** add strict partition ensemble postprocessing ([4e8fe6e](https://github.com/QoroQuantum/divi/commit/4e8fe6edab950fbc47db1088afa75eb1cd73341b))
* **qprog:** data-binding pipeline for CustomVQA and PennyLane ingestion ([fc8e371](https://github.com/QoroQuantum/divi/commit/fc8e371e2b4aea333808347644347f810edb73a3))
* **qprog:** expose ensemble concurrency on BatchConfig ([f05386e](https://github.com/QoroQuantum/divi/commit/f05386e77c8c806baf351c2c6bab60a8e5206edf))
* **qprog:** extend sample_solution to ProgramEnsemble; rename from compute_solution ([ad0beee](https://github.com/QoroQuantum/divi/commit/ad0beeeb7b1780ef1972734d26a2fbb9a2b7b792))
* **qprog:** QNN algorithm with feature-map encoders ([0af2213](https://github.com/QoroQuantum/divi/commit/0af2213f16604b65789592596b9e85ad33bc0d15))
...
* **routing:** TSPLIB parser coverage + binary CE-QAOA encoding for TSP ([7dcfe78](https://github.com/QoroQuantum/divi/commit/7dcfe788e34e12d0c04643e4746bd07c62031ded))
* time evolution class ([#57](https://github.com/QoroQuantum/divi/issues/57)) ([dec65f4](https://github.com/QoroQuantum/divi/commit/dec65f42a37f062c517c3d54b6abf109741ce4e2))
...
* add missing support for expval backends for PCE soft energy path ([70ce1cf](https://github.com/QoroQuantum/divi/commit/70ce1cf1c24c355ad5d603a4573c2692585aebec))
* address bugs in trotterization strategies found by co-pilot ([cd1797c](https://github.com/QoroQuantum/divi/commit/cd1797cf9605f0e7ceef418cd19a12fb8da0e375))
...
* attempting fix to address tutorial tests never terminating ([175426f](https://github.com/QoroQuantum/divi/commit/175426fc938fb15554f5083e5b02da73a81b6008))
...
* Ensure grouping is maintained ([798c3c0](https://github.com/QoroQuantum/divi/commit/798c3c0dca2ecc9f6f1174253d90d879b925500c))
...
* fixed parser not allowing scientific notation in qasm ([220f466](https://github.com/QoroQuantum/divi/commit/220f4668142e8264a00da2201e90cd06cc8f4b52))
...
* Fixing Maestro on MacOS ([614ff8e](https://github.com/QoroQuantum/divi/commit/614ff8e598ef73960c3ccf67b1de9d708de1dfe9))
* Fixing Maestro on MacOS ([7825308](https://github.com/QoroQuantum/divi/commit/7825308b6206df951e19c106b8bb1d4ac6dca457))
...
* **MaestroSimulator:** correct measurement stripping regex ([b2a3b28](https://github.com/QoroQuantum/divi/commit/b2a3b2819505a7fbfe3975c0ab24e92494657360))
* **matching:** correct bitstring decoding and add feasibility hooks ([6bf004a](https://github.com/QoroQuantum/divi/commit/6bf004a2a99623a975cbf3cb85d459a75b04cb99))
* **matching:** fix double-counting bug ([26c1ebc](https://github.com/QoroQuantum/divi/commit/26c1ebc7e30ebf42b1930247b68a7a5297eb4770))
...
* **pipeline:** restore imag-coeff warning; surface QuEPP zero-path no-op ([99696c1](https://github.com/QoroQuantum/divi/commit/99696c12d8f062fd3534b8787904a43a5ffc5f1f))
...
* **qaoa:** enforce cost/mixer/wire_labels qubit-count alignment ([d996899](https://github.com/QoroQuantum/divi/commit/d996899289a6f514d628068681dc63e46b708a80))
...
* **QDrift:** re-scaling coefficients before sampling to maintain dynamics faithfulness ([6f5f9ab](https://github.com/QoroQuantum/divi/commit/6f5f9ab367ce6103108cb28d96aba54acac7cc60))
...
* set seed in noisy_estimate_montecarlo, code quality improvements ([5442fe2](https://github.com/QoroQuantum/divi/commit/5442fe2790d53e0710d9bc340cc02f4286163ec7))
...
* Test case for compressed observables ([ff83606](https://github.com/QoroQuantum/divi/commit/ff8360667f7551a7ac853343ff245f4b6e2dd735))
...
* add cache to ExactTrotterization and fix seeding issue in QDrift ([f717e9a](https://github.com/QoroQuantum/divi/commit/f717e9ae06172c9c79d46b29561febcb7d3f8676))
* add Numba JIT compilation for hot-path functions ([6320f0c](https://github.com/QoroQuantum/divi/commit/6320f0c6d1fa5c98b2252e6f9f75201a31d6c216))
...
* **CircuitPipeline:** more robust deepcopying to mitigate pennylane deepcopy bug ([8dc3873](https://github.com/QoroQuantum/divi/commit/8dc38736f9b5f96a25cff3d89b5f1dbc3f9fdb01))
* Code clean ups and additional checks ([39bf76e](https://github.com/QoroQuantum/divi/commit/39bf76eefbfe4ee221bdf22ca7596de3f48f6415))
* consolidate cancellation helpers + auto-cancel direct backend callers ([76c7b4e](https://github.com/QoroQuantum/divi/commit/76c7b4e503cab74bd9cb367f651e25706ec51fd2))
...
* **hamiltonians:** consolidate observable-&gt;SPO helper into _term_ops ([c24bb68](https://github.com/QoroQuantum/divi/commit/c24bb68d09edde73ca1dc8841e7267ccc6c663ca))
* **hamiltonians:** migrate Hamiltonian arithmetic to SparsePauliOp ([9c33a03](https://github.com/QoroQuantum/divi/commit/9c33a037e0a97949d88d1bd8afb5321f6f43d3c1))
* **imports:** tighten import boundaries ([0b32295](https://github.com/QoroQuantum/divi/commit/0b32295a6f28189e6d630cd835292df13f510c23))
...
* **ProgramEnsemble:** extract shared state into PartitioningProgramEnsemble base class ([0dd3471](https://github.com/QoroQuantum/divi/commit/0dd3471da91a314e040b5bd361b19dcd68320ecf))
...
* **qprog:** add raise_on_constant flag to _clean_hamiltonian_spo ([425f963](https://github.com/QoroQuantum/divi/commit/425f9630a847518d9f855592ed0d0b5ed73be6c7))
...
* **qprog:** consolidate cancellation across single, pipeline, ensemble runs ([415d7e4](https://github.com/QoroQuantum/divi/commit/415d7e4e53a4ac2c96827c4da8feab4d34713441))
* **qprog:** consolidate cancellation across single, pipeline, ensemble runs ([53c5c9f](https://github.com/QoroQuantum/divi/commit/53c5c9fe448942b5f9f196dd9bd64a1e18205eeb))
* **qprog:** introduce ObservableMeasuringMixin and adopt across observable-measuring programs ([41b7b70](https://github.com/QoroQuantum/divi/commit/41b7b708bcb1aaf6f7f36cec7914d2dc51a7b485))
...
* remove unused decode-side sparse representation ([58e6e39](https://github.com/QoroQuantum/divi/commit/58e6e39405f51c5ac6ec5e709af13bb54caa4737))
...
* rename parse_vrp_file→parse_tsplib_file, VRPInstance→RoutingInstance ([d050730](https://github.com/QoroQuantum/divi/commit/d05073098f547bfb72f1b711fecf806e16c50d7d))
* rename pennylane alias qml -&gt; qp ([fcf6c08](https://github.com/QoroQuantum/divi/commit/fcf6c08ba8eb0b2062652e666f5d8e605552cedc))
* rename Problem to QAOAProblem and extract problems package ([cfc1ffa](https://github.com/QoroQuantum/divi/commit/cfc1ffa72e4e594d88367dceb199cb43da578c07))
...
* **tests:** reorganize tests by QAOAProblem class hierarchy ([0c793de](https://github.com/QoroQuantum/divi/commit/0c793def52cb3f7b780d7c3ac8493e14982c5f53))
...
* **tutorials:** consolidate, reorganize, de-noise ([cb3bc55](https://github.com/QoroQuantum/divi/commit/cb3bc55267598356af12e10eec8efa2ae44c864a))
...
* **workflows:** composition-based partitioning via QAOAProblem hooks ([243bd74](https://github.com/QoroQuantum/divi/commit/243bd7436c56f9f6686b032d5e265174604efe58))
...
* added AGENTS.md ([668d0d8](https://github.com/QoroQuantum/divi/commit/668d0d82889cfee67477bdb9df2d2b6f62f61c2a))
* Added commitizen for easier conv commits and pre-commit check guardrail ([b63684d](https://github.com/QoroQuantum/divi/commit/b63684dc5c2e9aae3d217b73f5345db72d711ccc))
* Added PyPi publishing CI script ([e964bf1](https://github.com/QoroQuantum/divi/commit/e964bf19ab8bd60c0bf8dfe83f82dc0931c59c66))
* Added release-please config file to use custom changelog headers ([3bf7cfd](https://github.com/QoroQuantum/divi/commit/3bf7cfdc7b3956d91f49a25ce428a915ed4dfefd))
* adjust tutorial timeout configuration ([3b8dbc6](https://github.com/QoroQuantum/divi/commit/3b8dbc6b3f06ec34e387bf453e614e03c8945208))
* **AGENTS.md:** added prevention note on inline imports ([7cff6e3](https://github.com/QoroQuantum/divi/commit/7cff6e364029a198b950ddc0a4bc9bf46c2faca9))
...
* clean up 0.12.0 CHANGELOG entries ([8bf5fef](https://github.com/QoroQuantum/divi/commit/8bf5fef43cbbfd88bb673c3bec9b08335787113a))
* correct nightly build versioning ([4bd3ab6](https://github.com/QoroQuantum/divi/commit/4bd3ab69fe7535aef61b59b86ccdf64bdabf86a0))
* correcting l-bfgs-b tests ([4c02d25](https://github.com/QoroQuantum/divi/commit/4c02d258bfc574d0ab067835cb03d6ac2a74039b))
* deleted now-obsolete changelog check script ([1ecda5f](https://github.com/QoroQuantum/divi/commit/1ecda5fc65f126778f87362ee9a29af568b3b109))
...
* entry in tutorials ci for new qdrift tutorial ([cad3fa7](https://github.com/QoroQuantum/divi/commit/cad3fa701ac132a8b864bf73ef94e9371ef605b4))
* factor workflow setup into composite actions ([8a2fdf6](https://github.com/QoroQuantum/divi/commit/8a2fdf619fc351377d32ca82c76ca564efc10d19))
* figure out why plucky is breaking the ci workflow ([fc04402](https://github.com/QoroQuantum/divi/commit/fc04402526a810a0496630cac10ececcb0561a4b))
* fix broken tutorials ([1fe3d06](https://github.com/QoroQuantum/divi/commit/1fe3d060c3941583c95fec5e45bb7a90131a5848))
* fix docs workflow ([d3b6a55](https://github.com/QoroQuantum/divi/commit/d3b6a5512c2742bc68a9688009fa42658ba91e6d))
* fix issue with docs ci/cd script ([8d7ffbf](https://github.com/QoroQuantum/divi/commit/8d7ffbf0cb1762cd3dc538d199f92d2a1fd5c17c))
* fix release please ci/cd action ignoring config file ([a3fdd17](https://github.com/QoroQuantum/divi/commit/a3fdd17f08e308b9d3b6dee17faea2bd8b1bd800))
* fix wrong autoflake config ([672bef0](https://github.com/QoroQuantum/divi/commit/672bef0d28306ac160d88aa426a385ba926831f0))
* fix wrong release-please manifest version ([555e9bb](https://github.com/QoroQuantum/divi/commit/555e9bbef1290cf7c52feed5ede84b95bc4ecafd))
* fixing grouping tutorial ([c6cddb9](https://github.com/QoroQuantum/divi/commit/c6cddb9657ae103c563eef56992fce56b9400b80))
* improve coverage for PCE, checkpointing, grouping, and core pipeline functions ([7e61cad](https://github.com/QoroQuantum/divi/commit/7e61cadbf8eaa16bb925ba28e2784d1439aea54f))
* introduce nightly pypi builds ([a86b7d6](https://github.com/QoroQuantum/divi/commit/a86b7d61b64cd4a6385d9ad082c992865f3f923a))
* **main:** release 0.10.0 ([c166686](https://github.com/QoroQuantum/divi/commit/c166686cf97407fafcdcc3603012997f80f668b6))
* **main:** release 0.10.0 ([ff7de91](https://github.com/QoroQuantum/divi/commit/ff7de917906c7950d18dfa887d0550c102be3b33))
* **main:** release 0.11.0 ([#74](https://github.com/QoroQuantum/divi/issues/74)) ([8816124](https://github.com/QoroQuantum/divi/commit/88161247f3b6431d298ef10b0ae3b7ac67d6010f))
* **main:** release 0.11.1 ([#78](https://github.com/QoroQuantum/divi/issues/78)) ([f321788](https://github.com/QoroQuantum/divi/commit/f3217887eb1c72e279183eb0fe384a0f5ce9ad70))
* **main:** release 0.12.0 ([79635f9](https://github.com/QoroQuantum/divi/commit/79635f96d1974cbeaa075dd1c79515a9fe921ef7))
* **main:** release 0.12.0 ([f27af35](https://github.com/QoroQuantum/divi/commit/f27af359d261fd7f346fbf5d095fb449cb3949be))
* **main:** release 0.5.0 ([#37](https://github.com/QoroQuantum/divi/issues/37)) ([cdf4295](https://github.com/QoroQuantum/divi/commit/cdf42955d360eb34fc8f2eff70f43956dcde3841))
* **main:** release 0.6.1 ([#49](https://github.com/QoroQuantum/divi/issues/49)) ([3642d9a](https://github.com/QoroQuantum/divi/commit/3642d9a8e717118c496ea8967e332a7bda575702))
* **main:** release 0.7.0 ([#50](https://github.com/QoroQuantum/divi/issues/50)) ([b8142f4](https://github.com/QoroQuantum/divi/commit/b8142f410d5b700967a96cf3d7df748a5643d322))
* **main:** release 0.8.0 ([#58](https://github.com/QoroQuantum/divi/issues/58)) ([c063b30](https://github.com/QoroQuantum/divi/commit/c063b305a8079823946f65bd007a1ed654d395a5))
* **main:** release 0.9.0 ([#60](https://github.com/QoroQuantum/divi/issues/60)) ([b58230d](https://github.com/QoroQuantum/divi/commit/b58230df50024d4097afde01af0d25e8e856739d))
* merge decoded top-N PCE branch ([453657e](https://github.com/QoroQuantum/divi/commit/453657e8baff28a27a31cc447d4d0428860afcfd))
* merge main into orqviz ([9be6396](https://github.com/QoroQuantum/divi/commit/9be63967d3f64892dbf86b80cac08b4707c01e73))
* merge PCE polynomial encoding branch ([c7edeae](https://github.com/QoroQuantum/divi/commit/c7edeae32310d81fd76781c2d9e1577401334db7))
* Merge pull request [#36](https://github.com/QoroQuantum/divi/issues/36) from Smitsavaliya49/QCC_Ansatz ([0c517d9](https://github.com/QoroQuantum/divi/commit/0c517d9f31cf76d43ab6fb0abc1eda09f70ddf81))
* Merge pull request [#52](https://github.com/QoroQuantum/divi/issues/52) from QoroQuantum/qdrift ([2941490](https://github.com/QoroQuantum/divi/commit/2941490f9590a205aa0ccb8ba4462a2abf7e735b))
* merge pull request [#55](https://github.com/QoroQuantum/divi/issues/55) from QoroQuantum/pipelines ([224696c](https://github.com/QoroQuantum/divi/commit/224696ca55e3f9872a66d84ef9b2d59a8cecc158))
...
* Merge pull request [#65](https://github.com/QoroQuantum/divi/issues/65) from QoroQuantum/graph-qubo-wf ([f3d6a56](https://github.com/QoroQuantum/divi/commit/f3d6a56a66d66648210caa0baa70e0a9fb34f995))
* Merge pull request [#66](https://github.com/QoroQuantum/divi/issues/66) from QoroQuantum/fix/maestro-on-mac ([614ff8e](https://github.com/QoroQuantum/divi/commit/614ff8e598ef73960c3ccf67b1de9d708de1dfe9))
* Merge pull request [#67](https://github.com/QoroQuantum/divi/issues/67) from QoroQuantum/feat/compressed-observables ([178fdb9](https://github.com/QoroQuantum/divi/commit/178fdb990dac13cb49f28f266e8d0e5128a0d021))
...
* Merge pull request [#79](https://github.com/QoroQuantum/divi/issues/79) from QoroQuantum/release-please--branches--main ([79635f9](https://github.com/QoroQuantum/divi/commit/79635f96d1974cbeaa075dd1c79515a9fe921ef7))
* Merge pull request [#82](https://github.com/QoroQuantum/divi/issues/82) from QoroQuantum/maestro-noise ([42775ab](https://github.com/QoroQuantum/divi/commit/42775abb2ecfa1069f314138b8cac39d04d84172))
* Merge pull request [#83](https://github.com/QoroQuantum/divi/issues/83) from QoroQuantum/feat/pennylane-to-qiskit ([b64e7b5](https://github.com/QoroQuantum/divi/commit/b64e7b540332a0c7986d8a9d75d693ea0c6ba764))
* Merge pull request [#84](https://github.com/QoroQuantum/divi/issues/84) from QoroQuantum/cleaner-cancellation-output ([415d7e4](https://github.com/QoroQuantum/divi/commit/415d7e4e53a4ac2c96827c4da8feab4d34713441))
* Merge pull request [#85](https://github.com/QoroQuantum/divi/issues/85) from QoroQuantum/feat/qnn-algorithm ([1948c56](https://github.com/QoroQuantum/divi/commit/1948c565b99e30fe7f5e4360fe210bc7730d9257))
...
* remove spurious blank line ([a3b4810](https://github.com/QoroQuantum/divi/commit/a3b4810a035594f240817d9edbe04c57a5cd7086))
...
* tests for the new TrotterizationStrategy implementations ([83f3b34](https://github.com/QoroQuantum/divi/commit/83f3b34728de7489ceab47d8999aa0e83365bf83))
...
* update pydantic, mitiq constraints and fix deprecation warning ([5401e4b](https://github.com/QoroQuantum/divi/commit/5401e4b455b7cf2d671d904a904567967d427edd))
* use official poetry routine and fix nightly script ([a09a724](https://github.com/QoroQuantum/divi/commit/a09a724eb619a116cbc1e6379de4ccc39cdd4b08))
* v0.10.0 changelog cleanup ([751f8e3](https://github.com/QoroQuantum/divi/commit/751f8e3cad67d2d08cfb1caf0055e1c5f159e48d))
* version bump and changelog update ([80b87fb](https://github.com/QoroQuantum/divi/commit/80b87fb0758407f14dd37fa0910e2eb3901d7657))
* Windows CI/CD([#53](https://github.com/QoroQuantum/divi/issues/53)) ([0680205](https://github.com/QoroQuantum/divi/commit/06802056ae81d2d7c1fed0485b36c0203a06644f))
...
* change docs theme to furo ([f3d02a2](https://github.com/QoroQuantum/divi/commit/f3d02a24e787a83ab2061eb40437ebde71729211))
...
* documentation for trotterization strategies (exact, qdrift) ([28fe7a5](https://github.com/QoroQuantum/divi/commit/28fe7a5d890375a992a4cd5202d497a44412c89a))
...
* fix DRY violations and stale import paths ([1fa0c7e](https://github.com/QoroQuantum/divi/commit/1fa0c7e6c85dbfe41df8250d07bb87f288768546))
...
* replace pipelines text figure with mermaid figure ([1d2ba3e](https://github.com/QoroQuantum/divi/commit/1d2ba3e3bed306810fb5499a77e1cb3fb0a94de1))
...
* fix DRY violations and stale import paths ([f4adada](https://github.com/QoroQuantum/divi/commit/f4adadaebd509f519d9801e289e81bec06c3a13c))
...
* Refactored `CircuitRunner` interface: updated `submit_circuits()` to return `ExecutionResult` instead of a raw job ID or result list. This change standardizes the interface for both synchronous (e.g., `ParallelSimulator`) and asynchronous (e.g., `QoroService`) backends
* Improved `ParallelSimulator` runtime estimation: enhanced the runtime estimation logic in `ParallelSimulator` to better account for instruction durations and parallel execution scheduling using a Longest Processing Time (LPT) algorithm
